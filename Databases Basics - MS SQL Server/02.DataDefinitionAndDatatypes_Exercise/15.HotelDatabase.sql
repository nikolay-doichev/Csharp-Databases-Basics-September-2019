...
CREATE TABLE Rooms (
	...
	RoomType VARCHAR(30) FOREIGN KEY REFERENCES RoomType(RoomType),
	BedType VARCHAR(30) FOREIGN KEY REFERENCES BedType(BedType),
	Rate INT NOT NULL,
